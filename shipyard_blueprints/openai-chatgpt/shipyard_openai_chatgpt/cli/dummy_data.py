...
def main():
    ...
    completion = openai.ChatCompletion.create(
      model="gpt-3.5-turbo",
      messages=[
        {"role": "user", "content": f"Generate {number_of_rows} lines of the following fake data: {column_names}. The result should be presented in CSV format with a header row"}
      ]
    )
