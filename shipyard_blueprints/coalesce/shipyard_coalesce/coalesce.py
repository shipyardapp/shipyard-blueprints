...
class CoalesceClient(Etl):
    ...
    def trigger_sync(self, environment_id:str, job_id:str, snowflake_username:str, snowflake_password:str, snowflake_role:str, snowflake_warehouse:str = None, 
                     parallelism:int = 16, include_nodes_selector:str = None, exclude_nodes_selector = None) -> dict[any,any]:
        """
        ...
        details = {"environmentID": environment_id,
