...
def get_args():
    ...
    parser.add_argument(
        "--access-token", required=True, help="Your Trello access token."
    )
    parser.add_argument("--api-key", required=True, help="Your Trello API key.")
    parser.add_argument(
        "--card-id", required=True, help="The ID of the Trello card you wish to update."
    )
    parser.add_argument(
        "--board-id", help="The ID of the Trello board you wish to move the card to."
    )
    parser.add_argument(
        "--list-name", help="The name of the Trello list you wish to move the card to."
    )
