...
if __name__ == "__main__":
    ...
    client = SalesforceClient(
        access_token="",  # Leaving blank to generate fresh access token
        domain=domain,
        username=username,
    ...
    # client.connect()
    # details = client.get_resource('contact')
    # print(details)
    # for detail in details.get('fields'):
    #     print('----------------')
    #     print(detail.get('name'))
    #     print(detail.get('label'))
    #     print(detail.get('type'))
    #     print(detail.get('length'))

    # print(client.get_resource_fields('account'))
    # print(client.execute_soql_query('SELECT Id, Name FROM Account'))
    # print(client.get_records_by_fields('account', ['Id', 'Name']))
