...
class MicrosoftTeamAuthtestTestCase(unittest.TestCase):
    ...
    def test_main_with_valid_webhook(self, mock_exit):
        os.environ['MICROSOFT_TEAMS_WEBHOOK_URL'] = os.getenv('TEST_MICROSOFT_TEAMS_WEBHOOK_URL')
        main()
    ...
    def test_main_with_invalid_webhook(self, mock_exit):
        os.environ[
            'MICROSOFT_TEAMS_WEBHOOK_URL'] = 'https://shipyardapp.webhook.office.com/webhookb2/invalid_webhook_url'
        main()
