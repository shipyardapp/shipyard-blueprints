...
def get_args():
    ...
    parser.add_argument(
        "--wait-for-completion", default=True, help="Wait for pipeline run completion"
    )
...
def main():
    try:
        ...
        adf_client = AzureDataFactoryClient(
            args.client_id, args.client_secret, args.tenant_id, args.subscription_id
        )
        adf_client.trigger_sync(
            args.resource_group,
            args.data_factory_name,
            args.pipeline_name,
